                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/SearchCustomerServlet" class="waves-effect waves-dark">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/stores" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-shopping-cart"></i></span>
                                        <span class="pcoded-mtext">Stores</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/notifications" class="waves-effect waves-dark">
