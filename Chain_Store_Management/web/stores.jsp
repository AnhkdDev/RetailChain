...
<html>
<head>
    <title>Manage Stores - Store Manager</title>
    <meta charset="utf-8">
...
<body>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">View and manage store information.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="breadcrumb-item"><a href="index.jsp"><i class="fa fa-home"></i></a></li>
                                            <li class="breadcrumb-item"><a href="stores.jsp">Stores</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="stores" method="get" class="form-material">
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <div class="form-group form-primary">
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="store" items="${stores}">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="#editForm" class="btn btn-primary btn-sm" onclick="populateForm('${store.storeID}', '${store.storeName}', '${store.address}', '${store.phoneNumber}')">Edit</a>
                                                                                <a href="stores?action=delete&storeID=${store.storeID}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this store?')">Delete</a>
                                                                            </td>
                                                                        </tr>
                                                                    </c:forEach>
                                                                    <c:if test="${empty stores}">
                                                                        <tr><td colspan="5" class="text-center">No stores available.</td></tr>
                                                                    </c:if>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="text-right m-r-20">
                                                            <a href="#editForm" class="btn btn-success" onclick="clearForm()">Add New Store</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-block">
                                                        <form action="stores" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="storeId" name="storeID" placeholder="e.g., S004" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
    ...
    <script>
        function populateForm(id, name, address, phone) {
            ...
            document.getElementById('storeId').readOnly = true; // Lock StoreID when editing
        }
        function clearForm() {
            ...
            document.getElementById('storeId').readOnly = false; // Unlock StoreID when adding new
        }
    </script>
</body>
</html>
