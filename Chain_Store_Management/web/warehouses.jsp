...
<body>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">View and manage warehouse details</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="inventory.jsp">Inventory</a></li>
                                            <li class="breadcrumb-item"><a href="#!">Manage Warehouses</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="card table-card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-header-right">
                                                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#warehouseModal" onclick="resetForm()">Add New Warehouse</button>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="warehouse" items="${warehouses}">
                                                                        <tr>
                                                                            ...
                                                                            <td><c:out value="${warehouse.storeName}"/></td>
                                                                            <td>
                                                                                <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#warehouseModal" onclick="editWarehouse('${warehouse.warehouseID}', '${warehouse.warehouseName}', '${warehouse.storeID}')">
                                                                                    <i class="fa fa-edit"></i> Edit
                                                                                </button>
                                                                                <button class="btn btn-sm btn-danger" onclick="deleteWarehouse('${warehouse.warehouseID}')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="warehouseModalLabel">Add/Edit Warehouse</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="warehouseForm" action="warehouseAction" method="post">
    ...
    <!-- Custom Script for Warehouse Management -->
    <script>
        function resetForm() {
        ...
        function editWarehouse(warehouseID, warehouseName, storeID) {
        ...
        function deleteWarehouse(warehouseID) {
            if (confirm('Are you sure you want to delete this warehouse?')) {
                // Assuming a servlet or endpoint handles deletion
                window.location.href = 'warehouseAction?action=delete&warehouseID=' + warehouseID;
            }
        }
    </script>
</body>
