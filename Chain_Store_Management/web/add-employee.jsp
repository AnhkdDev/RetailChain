...
<head>
    ...
    <meta name="description" content="Add a new employee to the store." />
    <meta name="keywords" content="add employee, staff, retail" />
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Fill in the details to add a new employee</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="employeeAction" method="post">
                                                            ...
                                                            <a href="employees.jsp" class="btn btn-secondary">Cancel</a>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
