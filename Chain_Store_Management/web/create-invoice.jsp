...
<head>
    ...
    <meta name="description" content="Create a new invoice for the store." />
    <meta name="keywords" content="invoice creation, sales, retail" />
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu active">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="active"><a href="create-invoice.jsp">Create Invoice</a></li>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Fill in the details to create a new invoice</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                        ...
                                                        <form action="invoices" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="customerID" name="customerID">
                                                                    ...
                                                                    <c:forEach var="customer" items="${customers}">
                                                                        <option value="${customer.customerID}"><c:out value="${customer.fullName}"/></option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="paymentMethodID" name="paymentMethodID" required>
                                                                    ...
                                                                    <c:forEach var="paymentMethod" items="${paymentMethods}">
                                                                        <option value="${paymentMethod.paymentMethodID}"><c:out value="${paymentMethod.methodName}"/></option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div id="invoiceDetails">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2 form-group">
                                                                        <label for="unitPrice_1">Unit Price</label>
                                                                        <input type="number" step="0.01" class="form-control" id="unitPrice_1" name="unitPrice_1" min="0" required>
                                                                    </div>
                                                                    <div class="col-md-2 form-group">
                                                                        <label for="discountPercent_1">Discount (%)</label>
                                                                        <input type="number" step="0.01" class="form-control" id="discountPercent_1" name="discountPercent_1" min="0" max="100">
                                                                    </div>
                                                                    <div class="col-md-2 form-group">
                                                                        <label>&nbsp;</label>
        ...
        function addDetail() {
            ...
            const newDetail = `
                <div class="row mt-2" id="detail_${detailCount}">
                    ...
                    <div class="col-md-2 form-group">
                        <label for="unitPrice_${detailCount}">Unit Price</label>
                        <input type="number" step="0.01" class="form-control" id="unitPrice_${detailCount}" name="unitPrice_${detailCount}" min="0" required>
                    </div>
                    <div class="col-md-2 form-group">
                        <label for="discountPercent_${detailCount}">Discount (%)</label>
                        <input type="number" step="0.01" class="form-control" id="discountPercent_${detailCount}" name="discountPercent_${detailCount}" min="0" max="100">
                    </div>
                    <div class="col-md-2 form-group">
                        <label>&nbsp;</label>
