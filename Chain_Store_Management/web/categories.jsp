                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu active">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="active"><a href="categories.jsp">Manage Categories</a></li>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Manage product categories</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-header-right">
                                                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addCategoryModal">Add New Category</button>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="category" items="${categories}">
                                                                        <tr>
                                                                            ...
                                                                            <td><c:out value="${category.typeName}"/></td>
                                                                            <td>
                                                                                <a href="edit-category.jsp?id=${category.categoryID}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                                                                <a href="delete-category?id=${category.categoryID}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    </c:forEach>
                                                                </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="add-category" method="post" class="form-material">
                                <div class="form-group form-primary">
