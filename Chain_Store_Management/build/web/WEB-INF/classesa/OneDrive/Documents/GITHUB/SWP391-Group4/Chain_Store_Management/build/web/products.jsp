...
<head>
    ...
    <style>
        ...
        .toggle-btn { padding: 2px 6px; font-size: 0.8rem; }
        .modal-dialog { max-width: 800px; }
        .modal-body img { max-width: 200px; margin: 5px; }
        .invalid-feedback { display: none; }
        .form-group.invalid .invalid-feedback { display: block; color: #dc3545; }
        @media (max-width: 768px) {
            .card-header-right { margin-top: 10px; }
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <p><strong>Unit:</strong> <c:out value="${product.unit}"/></p>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form action="${pageContext.request.contextPath}/update-product" method="post" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <div class="form-group row ${empty product.unit || (not empty errors and errors.contains('Unit is required.')) ? 'invalid' : ''}">
                                                                                                ...
                                                                                                <div class="col-sm-9">
                                                                                                    <input type="text" class="form-control" name="unit" value="${not empty product ? product.unit : ''}" required>
                                                            ...
                                                            <nav aria-label="Page navigation">
                                                                <ul class="pagination">
                                                                    <c:if test="${currentPage > 1}">
                                                                        <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/products?page=${currentPage - 1}&search=${param.search}">Previous</a></li>
                                                                    </c:if>
                                                                    <c:forEach begin="1" end="${totalPages}" var="pageNum">
                                                                        <li class="page-item ${pageNum == currentPage ? 'active' : ''}">
                                                                            <a class="page-link" href="${pageContext.request.contextPath}/products?page=${pageNum}&search=${param.search}"> ${pageNum}</a>
                                                                        </li>
                                                                    </c:forEach>
                                                                    <c:if test="${currentPage < totalPages}">
                                                                        <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/products?page=${currentPage + 1}&search=${param.search}">Next</a></li>
                                                                    </c:if>
                                                                </ul>
                                                            </nav>
                                                        </c:if>
