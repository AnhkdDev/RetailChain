                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="product" items="${products}">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <!-- View Details button -->
                                                                                <button class="btn btn-sm btn-info waves-effect waves-light" data-toggle="modal" data-target="#productDetailsModal" onclick="populateDetails('<c:out value="${product.productID}"/>', '<c:out value="${product.productName}"/>', '<c:out value="${product.categoryName}"/>', '<c:out value="${product.size}"/>', '<c:out value="${product.color}"/>', ${product.price}, ${product.isActive})" title="View Details">
                                                                                    <i class="fa fa-eye"></i>
                                                                                </button>
                                                                            </td>
                                                                        </tr>
