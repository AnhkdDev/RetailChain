...
<head>
    ...
    <meta name="description" content="View and manage invoices for the store." />
    <meta name="keywords" content="invoices, sales, retail" />
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">View Invoices</h5>
                                            <p class="m-b-0">List of all invoices</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">View Invoices</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="invoice" items="${invoices}">
                                                                        <tr>
                                                                            ...
                                                                            <td><c:out value="${invoice.storeName}"/></td>
