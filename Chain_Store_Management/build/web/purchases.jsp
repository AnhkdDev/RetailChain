                            ...
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <li class="pcoded-hasmenu active">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="active"><a href="purchases.jsp">View Purchases</a></li>
                                                    ...
                                                    <div class="card table-card">
                                                        <div class="card-header">
                                                            ...
                                                            <div class="card-header-right">
                                                                <a href="create-purchase.jsp" class="btn btn-primary btn-sm">Create New Purchase</a>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="s" items="${listpurchase}">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button class="btn btn-sm btn-info" onclick="viewDetails(${s.purchaseID})">
                                                                                    <i class="fa fa-eye"></i> View Details
                                                                                </button>
                                                                                <button class="btn btn-sm btn-warning" onclick="editPurchase(${s.purchaseID})">
                                                                                    <i class="fa fa-edit"></i> Edit
                                                                                </button>
                                                                                <button class="btn btn-sm btn-danger" onclick="deletePurchase(${s.purchaseID})">
...
<!--    <script>
                                                                                    function viewDetails(purchaseID) {
                                                                                        window.location.href = 'purchase-details.jsp?purchaseID=' + purchaseID;
                                                                                    }
    </script>-->
<script>
    function viewDetails(purchaseID) {
    ...
    function editPurchase(purchaseID) {
        window.location.href = 'edit-purchase.jsp?purchaseID=' + purchaseID;
    }

    function deletePurchase(purchaseID) {
        if (confirm('Are you sure you want to delete this purchase?')) {
            window.location.href = 'Purchase?action=delete&purchaseID=' + purchaseID;
        }
    }
</script>
</body>
