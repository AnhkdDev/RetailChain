...
<html>
<head>
    <title>Payment Methods - Store Manager</title>
    <meta charset="utf-8">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="main-menu-header">
                                ...
                                <div class="user-details">
                                    <span id="more-details">John Smith <i class="fa fa-caret-down"></i></span>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Payment Methods Management</h5>
                                            <p class="m-b-0">View and manage payment methods.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>PM001</td>
                                                                        <td>Cash</td>
                                                                        <td>Payment with physical cash</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>PM002</td>
                                                                        <td>Credit Card</td>
                                                                        <td>Payment via credit/debit card</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>PM003</td>
                                                                        <td>Electronic Wallet</td>
                                                                        <td>Payment via e-wallet (e.g., PayPal, Momo)</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Invoices Linked to Payment Methods</h5>
                                                        <div class="card-header-right">
                                                            <ul class="list-unstyled card-option">
                                                                <li><i class="fa fa-window-maximize full-card"></i></li>
                                                                <li><i class="fa fa-minus minimize-card"></i></li>
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>Cash</td>
                                                                        <td>$500.00</td>
                                                                        <td>2025-05-22 01:53</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>INV002</td>
                                                                        <td>Credit Card</td>
                                                                        <td>$1,200.00</td>
                                                                        <td>2025-05-21 14:30</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>INV003</td>
                                                                        <td>Electronic Wallet</td>
