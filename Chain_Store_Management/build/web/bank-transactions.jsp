...
<head>
    ...
    <meta name="description" content="View and manage bank transactions." />
    <meta name="keywords" content="bank transactions, payments, retail" />
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu active">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="active"><a href="bank-transactions.jsp">Bank Transactions</a></li>
                                    </ul>
                                </li>
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Bank Transactions</h5>
                                            <p class="m-b-0">List of all bank transactions</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Bank Transactions</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="alert alert-warning">No bank transactions found.</div>
                                                                    ...
                                                                    <c:forEach var="transaction" items="${bankTransactions}">
                                                                        <tr>
                                                                            ...
                                                                            <td><c:out value="${transaction.invoiceID}"/></td>
                                                                            <td><c:out value="${transaction.bankName}"/></td>
                                                                            <td><c:out value="${transaction.accountNumber}"/></td>
                                                                            <td><fmt:formatNumber value="${transaction.amount}" type="currency"/></td>
                                                                            <td><label class="label label-<c:out value="${transaction.status == 'Pending' ? 'warning' : transaction.status == 'Failed' ? 'danger' : 'success'}"/>"><c:out value="${transaction.status}"/></label></td>
