...
<html lang="en">
    <head>
        ...
        <meta name="description" content="View and manage store inventory efficiently." />
                    ...
                    <div class="pcoded-wrapper">
                            ...
                            <div class="pcoded-inner-navbar main-menu">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details"><c:out value="${sessionScope.user.fullName}" default="Guest"/> <i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <li class="pcoded-hasmenu active pcoded-trigger">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <!--                                        <li class="active"><a href="inventory.jsp">View Inventory</a></li>-->
                                            <li class="active"><a href="inventory">View Inventory</a></li>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                ...
                                                <p class="m-b-0">Manage your stores inventory efficiently.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="inventory.jsp">View Inventory</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="page-body">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <!--                            <form class="form-material" action="inventory" method="get">
                                                                                    <div class="form-row">
                                                    ...
                                                    <c:forEach var="warehouse" items="${warehouses}">
                                                        ...
                                                        <c:if test="${param.warehouse == warehouse.warehouseID}">selected</c:if>>
                                            ...
                                            <div class="form-group col-md-4">
                                                <select name="category" class="form-control">
                                                    ...
                                                    <c:forEach var="category" items="${categories}">
                                                        ...
                                                        <c:if test="${param.category == category.categoryID}">selected</c:if>>
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="text" name="productName" class="form-control" 
                                                       placeholder="Product name..." value="${param.productName}">
                                                    ...
                                                    <form class="form-material" action="inventory" method="get">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <label for="warehouseSelect" class="float-label">Select Warehouse</label>
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <label for="categorySelect" class="float-label">Select Category</label>
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <input type="text" name="productName" class="form-control" id="productNameInput"
                                                                       placeholder="All Product" value="${param.productName}">
                                                                <label for="productNameInput" class="float-label">Search Product</label>
                                                            </div>
                                                        </div>
                                                        <button type="submit" class="btn btn-primary">Filter</button>
                                                        <a href="inventory" class="btn btn-secondary">Reset</a>
                        ...
                        <script>
                            ...
                            document.addEventListener('DOMContentLoaded', function () {
                                // Kiểm tra nếu là lần đầu load trang (không có tham số URL)
