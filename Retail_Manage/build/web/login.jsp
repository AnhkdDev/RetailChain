        ...
        <div class="container" id="container"> <%-- KHÔNG có class "right-panel-active" ban đầu --%>
            ...
            <div class="form-container sign-in-container">
                <form action="<%= request.getContextPath() %>/LoginServlet" method="post"> <%-- Thay LoginServlet bằng action xử lý đăng nhập của bạn --%>
                    ...
                    <input type="email" name="email" placeholder="Email" required/> <%-- Có thể là username hoặc email tùy logic backend --%>
                    <input type="password" name="password" placeholder="Password" required/>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    ...
                    <div class="overlay-panel overlay-right">
                        ...
                        <button class="ghost" id="signUp"> <a href="register.jsp">Đăng Ký</a> </button> <%-- Nút chuyển sang Register --%>
                    </div>
                </div>
            </div>
        </div>
